...
<head>
  ...
  <style>
    ...
    .country-dropdown-menu label:hover {
      background: #eee;
    }

    /* Custom triangle icons (Leaflet divIcons) */
    .custom-triangle svg,
    .custom-triangle-purple svg,
    .custom-triangle-yellow svg {
      display: block;
    }
  </style>
</head>
<body>
  <div class="controls">
    <div class="control-group">
      <div class="control-group-title">Zertifikate</div>
      <label><input type="checkbox" id="chkEnPlus" checked> ENplus</label>
      <label><input type="checkbox" id="chkDINplus" checked> DINplus</label>
      <label><input type="checkbox" id="chkSURE" checked> SURE</label>
      <label><input type="checkbox" id="chkCPP" checked> CPP</label>
      <label><input type="checkbox" id="chkOhneZert" checked> ohne Zertifikat</label>
    </div>

    <div class="control-group">
      <div class="control-group-title">Preisfarbe</div>
      <label><input type="checkbox" id="chkGruen" checked> Grün (≤ 260 €)</label>
      <label><input type="checkbox" id="chkOrange" checked> Orange (260–285 €)</label>
      <label><input type="checkbox" id="chkRot" checked> Rot (&gt;= 285 €)</label>
      <label><input type="checkbox" id="chkGrau" checked> Grau (kein Preis)</label>
    </div>

    <div class="control-group">
      <div class="control-group-title">Produkte</div>
      <label><input type="checkbox" id="chkPellets" checked> Pellets</label>
      <label><input type="checkbox" id="chkSaegerestholzNord" checked> Sägerestholz Nord</label>
    </div>

    <div class="control-group">
      <div class="control-group-title">Kunden</div>
      <label><input type="checkbox" id="chkKunden" checked> Kunden (lose)</label>
      <label><input type="checkbox" id="chkSackKunden" checked> Sackkunden</label>
    </div>

    <div class="control-group">
      <div class="control-group-title">Sackware-Filter</div>
      <label><input type="checkbox" id="chkSackFireflies"> Fireflies</label>
      <label><input type="checkbox" id="chkSack15kg"> 15 kg</label>
    </div>

    <div class="control-group">
      <div class="control-group-title">Länder</div>
      <div id="countryDropdown" class="country-dropdown">
        <button id="countryDropdownBtn" type="button">Alle Länder</button>
        <div id="countryDropdownMenu" class="country-dropdown-menu">
          <!-- Alphabetisch sortiert nach Landesnamen (Alle oben) -->
          <label>
            <input type="checkbox" class="countryChk" value="all" checked>
            Alle Länder
          </label>
          <label>
            <input type="checkbox" class="countryChk" value="be">
            Belgien
          </label>
          <label>
            <input type="checkbox" class="countryChk" value="de">
            Deutschland
          </label>
          <label>
            <input type="checkbox" class="countryChk" value="fr">
            Frankreich
          </label>
          <label>
            <input type="checkbox" class="countryChk" value="at">
            Österreich
          </label>
          <label>
            <input type="checkbox" class="countryChk" value="pl">
            Polen
          </label>
          <label>
            <input type="checkbox" class="countryChk" value="ch">
            Schweiz
          </label>
          <label>
            <input type="checkbox" class="countryChk" value="sk">
            Slowakei
          </label>
          <label>
            <input type="checkbox" class="countryChk" value="cz">
            Tschechien
          </label>
        </div>
      </div>
    ...
    <div class="control-group">
      <div class="control-group-title">Suche</div>
      <input id="searchInput" type="text" placeholder="Name/Ort eingeben und Enter">
    </div>
  </div>
  ...
  <script
    ...
    integrity="sha256-o9N1j7kGStb0v6Hb0wH2jvC2JbhtC1p2MjNpv0v+4WQ="
    crossorigin=""
  ></script>
  <!-- PapaParse für CSV -->
  <script src="https://cdnjs.cloudflare.com/ajax/libs/PapaParse/5.4.1/papaparse.min.js"
          integrity="sha512-Z7S9CFJ1C8bIvdAJZDE1ZwbjOORMOfLxG3B1h8CfB+0x1EcERkM7f5IhA0UVFTMLtzXvG0TRTCqiqD3iGkG6xg=="
