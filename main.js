...
function sackFilterAktiv(){
  const wantFireflies = document.getElementById("chkSackFireflies")?.checked ?? false;
  const want15kg      = document.getElementById("chkSack15kg")?.checked ?? false;
...
function updateLayers(){
  ...
  const sackKundenFlag = document.getElementById("chkSackKunden")?.checked ?? true;
